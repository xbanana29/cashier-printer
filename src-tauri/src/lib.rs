...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sync_cmds::get_sync_info,
            commands::sync_cmds::fix_firewall,
            commands::sync_cmds::add_manual_peer,
            commands::sync_cmds::remove_manual_peer,
            commands::app_cmds::get_app_version,
            commands::app_cmds::open_external,
            commands::app_cmds::check_for_update,
            commands::app_cmds::install_update,
        ])
